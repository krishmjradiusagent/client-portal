  ...
  ({ icon, label, active, disabled, onClick, className, ...props }, ref) => {
    return (
      <button
        ...
        onClick={onClick}
        className={cn(
          "inline-flex h-9 items-center justify-center gap-2 rounded-full border px-3 text-sm font-medium shadow-sm transition-all duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] whitespace-nowrap outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2",
